#!/bin/sh
set -e
# Code generated by godownloader on 2019-05-18T10:58:40Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for aeneasr/release-test

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/aeneasr/release-test/releases
